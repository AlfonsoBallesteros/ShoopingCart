            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('subTotal')}>
                  Sub Total <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th>
                  Sale <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {orderList.map((order, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{order.total}</td>
                  <td>{order.state ? 'true' : 'false'}</td>
                  <td>{order.productId ? <Link to={`product/${order.productId}`}>{order.productId}</Link> : ''}</td>
                  <td>{order.saleId ? <Link to={`sale/${order.saleId}`}>{order.saleId}</Link> : ''}</td>
