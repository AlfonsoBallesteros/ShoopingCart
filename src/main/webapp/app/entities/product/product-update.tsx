  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="shoppingCartApp.product.home.createOrEditLabel">Create or edit a Product</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : productEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="detailLabel" for="product-detail">
                  Detail
                </Label>
                <AvField id="product-detail" type="text" name="detail" />
              </AvGroup>
              <AvGroup>
