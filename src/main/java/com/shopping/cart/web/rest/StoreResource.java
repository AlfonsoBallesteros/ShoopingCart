...
/**
 * REST controller for managing {@link com.shopping.cart.domain.Store}.
 */
@RestController
@RequestMapping("/api")
public class StoreResource {
    ...
    public ResponseEntity<StoreDTO> updateStore(@RequestBody StoreDTO storeDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, storeDTO.getId()))
            .body(result);
    }
