...
import com.shopping.cart.config.audit.AuditEventConverter;
import com.shopping.cart.domain.PersistentAuditEvent;
...
import static com.shopping.cart.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
